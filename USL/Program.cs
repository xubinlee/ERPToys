...
namespace USL
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //jia
            if (Security.Encrypt(SystemManagement.GetMacAddressByNetworkInformation()).Equals("24FB02AD0EAB8D0BB569A4BD034AB3C1F57C3F6137CA54F7") ||
                ...
                Security.Encrypt(SystemManagement.GetMacAddressByNetworkInformation()).Equals("DEB38A683F4EF219838760319AB97910A46C26FF6D5FE53E") ||
            ...
            //    Security.Encrypt(SystemManagement.GetMacAddressByNetworkInformation()).Equals("5CCBE9C93521566EB0CB8449FD0FA36F4D6D27258972AD32"))
            //jia mei
            //if (Security.Encrypt(SystemManagement.GetMacAddressByNetworkInformation()).Equals("E4854D630B2C9CFDB371022C364CFBF5631147E107692957") ||
            ...
            //dazheng
            //if (Security.Encrypt(SystemManagement.GetMacAddressByNetworkInformation()).Equals("1C37A9B3376F50BFB5FCB7C28AC6ED60809A594BD4E7ADE1") ||
            ...
            //zewei
            //if (Security.Encrypt(SystemManagement.GetMacAddressByNetworkInformation()).Equals("56759C4F5C620766D7D9E4D6D8D789B0BD7675497054D69C") ||
