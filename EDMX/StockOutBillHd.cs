...
namespace EDMX
{
    ...
    [KnownType(typeof(StockOutBillDtl))]
    
    public partial class StockOutBillHd
    {
        public StockOutBillHd()
        {
            this.StockOutBillDtl = new HashSet<StockOutBillDtl>();
        }
    	...
    	[DataMember]
        public Nullable<System.Guid> Driver { get; set; }
    
    	[DataMember]
        public virtual ICollection<StockOutBillDtl> StockOutBillDtl { get; set; }
    }
}
